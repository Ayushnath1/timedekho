// 242 COUNTRIES WITH PRIMARY TIMEZONES
// (Full correct list)
const countries = {
...
// AUTO REFRESH
setInterval(() => {
  const country = document.getElementById("countryTitle").textContent;
  if (country !== "Select a Country") showTime(country);
}, 1000);
